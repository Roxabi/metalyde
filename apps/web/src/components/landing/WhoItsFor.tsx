  ...
  return (
    ...
    >
      <div className="px-7 py-12 sm:border-r sm:border-border md:px-14">
        <h3 className="mb-3.5 text-xl font-bold tracking-tight">{m.landing_who1_title()}</h3>
      ...
      <div className="px-7 py-12 md:px-14">
        <h3 className="mb-3.5 text-xl font-bold tracking-tight">{m.landing_who2_title()}</h3>
