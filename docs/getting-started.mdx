...
description: Quick start guide to use Metalyde
---

Quick start guide to use Metalyde.
...
git clone https://github.com/Roxabi/metalyde.git my-project
cd my-project

# Option B: Use as template (for a new project)
gh repo create my-project --template Roxabi/metalyde --private
