...
description: Quick start guide to get up and running with Metalyde
---

Quick start guide to get up and running with Metalyde.
...
Labels are included in the repository. If creating manually, the issue management doc has the full `gh label create` commands.
...
3. Check the [open issues](https://github.com/Roxabi/metalyde/issues)
