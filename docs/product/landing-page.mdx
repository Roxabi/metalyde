...
description: Complete landing page structure, hero copy variants, feature section copy, FAQ, and CTA strategy for Metalyde
---
...
**Title tag:**
```
Metalyde — TanStack Start + NestJS SaaS Starter with AI Agent Team
```
