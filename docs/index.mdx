...
- [How We Built It](./approach) — the ~2-3 hour build, and what it proves
- [Product](./product) — the product, the brand, and the positioning artifacts
- [Architecture & Stack](./architecture) — stack decisions and technical architecture
- [Development Process](./processes/dev-process) — how we work day to day
