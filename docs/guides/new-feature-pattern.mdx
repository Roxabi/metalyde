...
This guide is the single reference for building a new full-stack feature in Metalyde. It walks through every layer — from shared types to backend module to frontend route — and links to the detailed standards docs for each pattern.
