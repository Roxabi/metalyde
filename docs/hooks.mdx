---
title: Hooks
description: Guide to Git hooks (Lefthook) and Claude Code hooks configured in Metalyde
---

## Overview

Metalyde uses two layers of hooks: **Lefthook** for Git hooks (commit-msg, pre-commit, pre-push) and **Claude Code hooks** for in-editor automation during development.
