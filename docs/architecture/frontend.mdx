...
Documentation is served by a **standalone Next.js application** at `apps/docs/`, powered by Fumadocs v16. It is deployed separately to `docs.metalyde.roxabi.dev`.
...
- [Dev Environment](../guides/dev-environment) -- Local setup and tooling
